...
function writeProductsToFile() {
    const productosString = `const productos = ${JSON.stringify(productos)};\n\nmodule.exports = productos;`;
    fs.writeFileSync('productos.js', productosString);
    console.log("Productos escritos en el archivo productos.js");
}
