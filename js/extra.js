...
fetch(url)
    ...
    .then(objeto => {
        ...
        console.log(objeto); // Esto imprimirá todos los productos
...
function addCard(numero, valor, imagen, descripcion) {
    const cardHTML = `
            <article class="card">
...
function addCard_carrito(numero, valor, imagen, descripcion) {
    const cardHTML = `
            <article class="card">
                <div class="conteiner_img">
                    <img src="../${imagen}" class="card-img-top" alt="...">
